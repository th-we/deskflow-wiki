...
To send logs for Synergy 2, follow these steps:

1. Right-click on the blue background
2. Select "Send log" from the menu
2. Click on the "View log" link
3. The log will show in your browser
4. Copy the log link from your browser
5. Paste the link into your reply
6. Let me know which computer the log is for
7. Repeat for all of your computers
