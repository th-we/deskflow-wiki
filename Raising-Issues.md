...
1. Remove the [`unanswered`](https://github.com/deskflow/deskflow/labels/unanswered) label when you answer an issue.
1. Remove the [`triage`](https://github.com/deskflow/deskflow/labels/triage) label on:
   - Bugs: If you are able to reproduce the bug
   - Enhancement: If you accept the enhancement and belive it is in-scope
